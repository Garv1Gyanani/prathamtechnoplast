...
const useCases: UseCase[] = [
  {
    ...
    recommendedMachines: [
      { name: 'Hydrostatic Pressure Test', image: '/machine-hydrostatic.png', slug: 'hydrostatic-pressure' },
      { name: 'Bursting Pressure Tester', image: '/machine-bursting.png', slug: 'bursting-pressure' },
      { name: 'Impact Testing Machine', image: '/machine-impact.png', slug: 'impact-testing' },
      { name: 'Vicat Softening Point', image: '/machine-vicat.png', slug: 'vicat-softening' },
    ],
    icon: ClipboardCheck,
  },
  {
    ...
    recommendedMachines: [
      { name: 'Hydrostatic Pressure Test', image: '/machine-hydrostatic.png', slug: 'hydrostatic-pressure' },
      { name: 'Melt Flow Index Tester', image: '/machine-melt-flow.png', slug: 'melt-flow-index' },
      { name: 'Tensile Testing Machine', image: '/machine-tensile.png', slug: 'tensile-testing' },
      { name: 'Vicat Softening Point', image: '/machine-vicat.png', slug: 'vicat-softening' },
    ],
    icon: Beaker,
  },
  {
    ...
    recommendedMachines: [
      { name: 'Hydrostatic Pressure Test', image: '/machine-hydrostatic.png', slug: 'hydrostatic-pressure' },
      { name: 'Impact Testing Machine', image: '/machine-impact.png', slug: 'impact-testing' },
      { name: 'Pipe Notching Machine', image: '/machine-notching.png', slug: 'pipe-notching' },
    ],
    icon: HardHat,
  },
  {
    ...
    recommendedMachines: [
      ...
      { name: 'Bursting Pressure Tester', image: '/machine-bursting.png', slug: 'bursting-pressure' },
      { name: 'Impact Testing Machine', image: '/machine-impact.png', slug: 'impact-testing' },
      { name: 'Ring Stiffness Tester', image: '/machine-ring-stiffness.png', slug: 'ring-stiffness' },
    ],
    icon: FileText,
  },
];
